...
function drawTerrain() {
    ...
    var texTerrain = texLoader.load(chemin+'src/medias/images/logoTerrainV3.jpg'),
            matTerrain = new THREE.MeshBasicMaterial({map: texTerrain});
    terrain = new THREE.Mesh(geoTerrain, matTerrain);
    scene.add(terrain);
    texMur = texLoader.load(chemin+'src/medias/images/texAlu.jpg'),
...
function drawRaquettes() {
    ...
    texRaquette = texLoader.load(chemin+'src/medias/images/texMur.png'),
    ...
    raquetteJoueur.position.z = terrain.position.z + 14.5;
    ...
    raquetteAdversaire.position.z = terrain.position.z - 14.5;
...
function drawBouclier() {
    ...
    texBouclierAdversaire = new THREE.MeshBasicMaterial({transparent: true, opacity: 0.5, color: 0xffffff});
    bouclierAdversaire = new THREE.Mesh(geoBouclier, texBouclierAdversaire);
...
function drawGate() {
    ...
    loader.load(chemin+'src/medias/models/gate.json', function addModelToScene(geometry, materials) {
...
function drawShips() {
    var loader = new THREE.JSONLoader();
    loader.load(chemin+'src/medias/models/prometheusV2.json', function addModelToScene(geometry, materials) {
        var material = new THREE.MultiMaterial(materials);
...
function drawSpace() {
    var spacetex = texLoader.load(chemin+'src/medias/images/spaceV2.jpg');
...
function drawWater() {
    var waterNormals = texLoader.load(chemin+'src/medias/images/texGate.jpg');
...
function drawEnnemys() {
    var loader = new THREE.JSONLoader();
    loader.load(chemin+'src/medias/models/logoRa.json', function addModelToScene(geometry, materials) {
        var material = new THREE.MultiMaterial(materials);
    ...
    loader.load(chemin+'src/medias/models/logoBaal.json', function addModelToScene(geometry, materials) {
        var material = new THREE.MultiMaterial(materials);
    ...
    loader.load(chemin+'src/medias/models/logoApophis.json', function addModelToScene(geometry, materials) {
        var material = new THREE.MultiMaterial(materials);
...
function drawJoker() {
    ...
    texJokerSante = texLoader.load(chemin+'src/medias/images/jokers/health.jpg'),
    ...
    texJokerExtra = texLoader.load(chemin+'src/medias/images/jokers/extra.png'),
